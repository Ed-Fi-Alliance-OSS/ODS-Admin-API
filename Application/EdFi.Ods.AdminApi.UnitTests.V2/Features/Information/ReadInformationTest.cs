...
using EdFi.Ods.AdminApi.V2.Features.Information;
...
namespace EdFi.Ods.AdminApi.UnitTests.V2.Features.Information;
...
public class ReadInformationTest
{
    ...
    public async Task GetInformation_V2Mode_ReturnsVersionAndBuild()
    {
        ...
        result.Version.ShouldBe(EdFi.Ods.AdminApi.V2.Infrastructure.Helpers.ConstantsHelpers.Version);
        result.Build.ShouldBe(EdFi.Ods.AdminApi.V2.Infrastructure.Helpers.ConstantsHelpers.Build);
    }
