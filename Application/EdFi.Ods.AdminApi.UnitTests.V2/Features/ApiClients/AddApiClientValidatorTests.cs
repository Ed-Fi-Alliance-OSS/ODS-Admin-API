...
using System.Linq;
using EdFi.Ods.AdminApi.V2.Features.ApiClients;
using EdFi.Ods.AdminApi.V2.Infrastructure.Commands;
using NUnit.Framework;
using Shouldly;

namespace EdFi.Ods.AdminApi.UnitTests.V2.Features.ApiClients
{
    [TestFixture]
