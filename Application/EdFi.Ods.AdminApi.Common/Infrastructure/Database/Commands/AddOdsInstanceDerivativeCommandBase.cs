...
public abstract class AddOdsInstanceDerivativeCommandBase(IUsersContext context)
{
    private readonly IUsersContext _context = context;

    protected OdsInstanceDerivative ExecuteCore(int odsInstanceId, string? derivativeType, string? connectionString)
    {
