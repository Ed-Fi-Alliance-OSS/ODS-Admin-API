...
public class GetOdsInstanceDerivativesQueryCore : IGetOdsInstanceDerivativesQueryCore
{
    private readonly IUsersContext _usersContext;
    private readonly IOptions<AppSettings> _options;
    private readonly Dictionary<string, Expression<Func<OdsInstanceDerivative, object>>> _orderByColumnOds;

    public GetOdsInstanceDerivativesQueryCore(IUsersContext usersContext, IOptions<AppSettings> options)
    {
...
public interface IGetOdsInstanceDerivativesQueryCore
{
