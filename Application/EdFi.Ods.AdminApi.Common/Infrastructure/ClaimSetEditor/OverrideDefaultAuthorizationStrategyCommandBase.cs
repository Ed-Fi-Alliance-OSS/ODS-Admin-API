...
public abstract class OverrideDefaultAuthorizationStrategyCommandBase(ISecurityContext context)
{
    protected readonly ISecurityContext _context = context;

    protected void ExecuteCore(IOverrideDefaultAuthorizationStrategyModel model)
    {
    ...
    protected void ExecuteOnSpecificActionCore(OverrideAuthStrategyOnClaimSetModel model)
    {
        var authorizationStrategiesDictionary = GetAuthorizationStrategiesAsDictionary();
        var claimSetResourceClaimsToEdit = GetClaimSetResourceClaimsToEdit(model.ClaimSetId, model.ResourceClaimId);
    ...
    protected void ResetAuthorizationStrategyOverridesCore(OverrideAuthStrategyOnClaimSetModel model)
    {
    ...
    {
        var authorizationStrategiesDictionary = new Dictionary<int, EdFi.Security.DataAccess.Models.AuthorizationStrategy>();
