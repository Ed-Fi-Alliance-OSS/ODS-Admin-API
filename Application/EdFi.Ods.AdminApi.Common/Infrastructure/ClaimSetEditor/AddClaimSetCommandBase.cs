...
public interface IAddClaimSetModelCommon
{
    string? ClaimSetName { get; }
}

public abstract class AddClaimSetCommandBase(ISecurityContext context)
{
    private readonly ISecurityContext _context = context;

    protected int ExecuteCore(IAddClaimSetModelCommon claimSet)
    {
