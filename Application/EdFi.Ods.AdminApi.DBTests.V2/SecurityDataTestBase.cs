...
using ActionName = EdFi.Ods.AdminApi.V2.Infrastructure.ClaimSetEditor.Action;
using Application = EdFi.Admin.DataAccess.Models.Application;
using ClaimSetEditorTypes = EdFi.Ods.AdminApi.V2.Infrastructure.ClaimSetEditor;

namespace EdFi.Ods.AdminApi.DBTests.V2;
...
public abstract class SecurityDataTestBase : PlatformSecurityContextTestBase
{
    ...
    protected List<ClaimSetEditorTypes.ResourceClaim> ResourceClaimsForClaimSet(int securityContextClaimSetId)
    {
        ...
        {
            var getResourcesByClaimSetIdQuery = new ClaimSetEditorTypes.GetResourcesByClaimSetIdQuery(securityContext);
