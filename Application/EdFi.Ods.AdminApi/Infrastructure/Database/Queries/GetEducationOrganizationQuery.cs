...
public class GetEducationOrganizationQuery(AdminApiDbContext adminApiDbContext)
    : GetEducationOrganizationQueryCore(adminApiDbContext), IGetEducationOrganizationQuery
{
}
