...
public class GetApplicationsByOdsInstanceIdQuery(IUsersContext context)
    : GetApplicationsByOdsInstanceIdQueryCore(context), IGetApplicationsByOdsInstanceIdQuery
{
}
