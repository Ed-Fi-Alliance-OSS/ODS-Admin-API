...
public class GetOdsInstanceIdsByApplicationIdQuery(IUsersContext context) : GetOdsInstanceIdsByApplicationIdQueryBase(context), IGetOdsInstanceIdsByApplicationIdQuery
{
    ...
    {
        return ExecuteCore(applicationIds);
    }
}
