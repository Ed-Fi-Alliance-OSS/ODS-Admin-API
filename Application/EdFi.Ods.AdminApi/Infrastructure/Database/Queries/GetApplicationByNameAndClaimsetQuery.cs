...
public class GetApplicationByNameAndClaimsetQuery(IUsersContext context)
    : GetApplicationByNameAndClaimsetQueryCore(context), IGetApplicationByNameAndClaimsetQuery
{
}
