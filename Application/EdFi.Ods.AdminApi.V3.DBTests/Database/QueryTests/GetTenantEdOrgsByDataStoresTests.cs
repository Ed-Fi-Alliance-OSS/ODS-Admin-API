...
{
    [Test]
    public void ShouldDistinguishLinkedAndUnlinkedDbDataStores()
    {
    ...
    [Test]
    public void ShouldReturnAllDbDataStores_WhenNoFiltersApplied()
    {
        Save(
    ...
    [Test]
    public void ShouldReturnAllDbDataStoreFields_ForLinkedDataStore()
    {
    ...
    [Test]
    public void ShouldReturnEmptyList_WhenNoDbDataStoresExist()
    {
        Transaction(context =>
        {
            var query = new GetDbDataStoresQuery(context, Testing.GetAppSettings());
