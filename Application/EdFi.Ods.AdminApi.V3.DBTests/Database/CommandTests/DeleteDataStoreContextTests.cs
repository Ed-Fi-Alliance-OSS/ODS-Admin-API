...
[TestFixture]
public class DeleteDataStoreContextTests : PlatformUsersContextTestBase
{
    ...
    public void ShouldDeleteOdsInstanceContext()
    {
        ...
        {
            var deleteOdsInstanceContextCommand = new DeleteDataStoreContextCommand(usersContext, new DeletedEntityAuditCapture(new DeletedEntitySnapshotRegistry()));
