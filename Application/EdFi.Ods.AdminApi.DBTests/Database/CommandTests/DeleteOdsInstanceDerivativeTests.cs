...
public class DeleteOdsInstanceDerivativeTests : PlatformUsersContextTestBase
{
    ...
    public void ShouldDeleteOdsInstanceDerivative()
    {
        ...
        {
            var deleteOdsInstanceDerivativeCommand = new DeleteOdsInstanceDerivativeCommand(usersContext, new DeletedEntityAuditCapture(new DeletedEntitySnapshotRegistry()));
