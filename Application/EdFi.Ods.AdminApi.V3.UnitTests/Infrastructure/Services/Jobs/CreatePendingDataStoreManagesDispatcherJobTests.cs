...
[TestFixture]
public class CreatePendingDataStoreManagesDispatcherJobTests
{
    ...
    public async Task Execute_SchedulesPendingOdsInstanceManage()
    {
        ...
        var job = new CreatePendingDataStoreManagesDispatcherJob(
            A.Fake<ILogger<CreatePendingDataStoreManagesDispatcherJob>>(),
            jobStatusService,
            adminApiContext,
