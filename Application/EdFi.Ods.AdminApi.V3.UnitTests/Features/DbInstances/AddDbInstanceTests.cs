...
public class AddDbInstanceTests
{
    ...
    public async Task Handle_WithValidRequest_ReturnsAccepted()
    {
        ...
        var result = await AddDbInstance.Handle(validator, command, schedulerFactory, tenantProvider, options, request, httpContext);
    ...
    public async Task Handle_WithValidRequest_PersistsDbInstance()
    {
        ...
        await AddDbInstance.Handle(validator, command, schedulerFactory, tenantProvider, options, request, httpContext);
    ...
    public async Task Handle_WithEmptyName_ThrowsValidationException()
    {
        ...
        await Should.ThrowAsync<ValidationException>(async () => await AddDbInstance.Handle(validator, command, schedulerFactory, tenantProvider, options, request, httpContext));
    }
    ...
    public async Task Handle_WithFormattedDatabaseNameExceedingPortableLimit_ThrowsValidationException()
    {
        ...
        var exception = await Should.ThrowAsync<ValidationException>(async () => await AddDbInstance.Handle(validator, command, schedulerFactory, tenantProvider, options, request, httpContext));
