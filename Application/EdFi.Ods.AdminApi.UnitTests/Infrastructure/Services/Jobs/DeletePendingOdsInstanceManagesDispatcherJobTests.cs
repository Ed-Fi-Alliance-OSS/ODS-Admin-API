...
[TestFixture]
public class DeletePendingOdsInstanceManagesDispatcherJobTests
{
    ...
    public async Task Execute_SchedulesPendingDeleteOdsInstanceManage()
    {
        ...
        var job = new DeletePendingOdsInstanceManagesDispatcherJob(
            A.Fake<ILogger<DeletePendingOdsInstanceManagesDispatcherJob>>(),
            jobStatusService,
            adminApiContext,
