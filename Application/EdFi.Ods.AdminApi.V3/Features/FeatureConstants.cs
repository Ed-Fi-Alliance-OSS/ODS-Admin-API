...
public static class FeatureConstants
{
    ...
    public const string DataStoreDerivativeTypeDescription = "derivative type.";
    public const string DataStoreDerivativeConnectionStringDescription = "connection string.";
    public const string DataStoreDerivativeTypeNotValid = "The value for the Derivative type is not allowed. The only accepted values are: 'ReadReplica' or 'Snapshot'.";
    public const string DataStoreContextIdDescription = "Data store context id.";
    ...
    public const string ApplicationResetCredentialNoApiClientsConflictMessage = "This Application has no ApiClients to reset. Use POST /v3/apiClients to add one first.";
}
