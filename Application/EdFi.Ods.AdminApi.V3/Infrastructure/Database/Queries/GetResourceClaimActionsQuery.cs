...
public class GetResourceClaimActionsQuery(ISecurityContext securityContext, IOptions<AppSettings> options)
    : GetResourceClaimActionsQueryBase(securityContext, options), IGetResourceClaimActionsQuery
{
    public IReadOnlyList<ResourceClaimActionModel> Execute(CommonQueryParams commonQueryParams, string? resourceName)
    {
