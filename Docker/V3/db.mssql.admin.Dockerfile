...
COPY --from=assets Application/EdFi.Ods.AdminApi.V3/Artifacts/MsSql/Structure/Admin/ /tmp/AdminApiScripts/Admin/MsSql
COPY --from=assets Application/EdFi.Ods.AdminApi.V3/Artifacts/MsSql/Structure/Security/ /tmp/AdminApiScripts/Security/MsSql
