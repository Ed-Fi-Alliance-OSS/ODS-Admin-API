...
**Tests**: Include test tasks for all behavior-changing work. At minimum,
include unit test tasks. Include DB/integration test tasks when data access,
query behavior, or migrations are affected.
...
- [ ] T004 Add constitution compliance checklist to the feature plan/tasks
...
- [ ] T011 [P] [US1] Unit test coverage for [behavior] in tests/unit/[name]
- [ ] T012 [P] [US1] Contract or integration test for [endpoint/journey] in tests/contract/ or tests/integration/
...
- [ ] T019 [P] [US2] Unit test coverage for [behavior] in tests/unit/[name]
- [ ] T020 [P] [US2] Contract or integration test for [endpoint/journey] in tests/contract/ or tests/integration/
...
- [ ] T025 [P] [US3] Unit test coverage for [behavior] in tests/unit/[name]
- [ ] T026 [P] [US3] Contract or integration test for [endpoint/journey] in tests/contract/ or tests/integration/
...
- [ ] TXXX [P] Additional unit tests to close behavior gaps in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run `./build.ps1 -Command UnitTest`
- [ ] TXXX Run `./build.ps1 -Command IntegrationTest` (when database impact exists)
